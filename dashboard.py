...
st.title("Analizar Reacciones y Comentarios")
# Pull data from the collection.
# Uses st.cache_data to only rerun when the query changes or after 10 min.
@st.cache_data(ttl=600)
def get_data():
    items = db.books_reactions.find()
...
def mostrar():
    listasdb = db.books_reactions.distinct("reactionId")
...
sidebar = st.sidebar
sidebar.title("Zurisaddai Reyes Juárez")
sidebar.write("Matricula: S20006762")
sidebar.write("zs20006762@estudiantes.uv.mx")
sidebar.markdown("_")
